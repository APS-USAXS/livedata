...
BISQUE_RGB = (255.0 / 255, 228.0 / 255, 196.0 / 255)  # 255 228 196 bisque
MINTCREAM_RGB = (245.0 / 255, 255.0 / 255, 250.0 / 255)  # 245 255 250 MintCream

SYMBOL_LIST = ("^", "D", "s", "v", "d", "<", ">")
COLOR_LIST = (
    "orange salmon lime green blue purple violet chocolate gray black".split()
...
def livedata_plot(datasets, plotfile, title=None):
    ...
    for i, ds in enumerate(datasets):
        try:
            ...
            (pl,) = ax.plot(
                ds.Q, ds.I, symbol, label=label, mfc="w", mec=color, ms=3, mew=1
            )
